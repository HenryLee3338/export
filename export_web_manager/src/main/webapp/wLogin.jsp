...
<script>
    window.onload = function () {
        if (window.parent.window != window) {
            window.top.location = "/wLogin.jsp";
        }
    }
</script>
...
<div class="login-box">
    <div class="login-logo">
        <a href="all-admin-index.html">微信绑定</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">请输入需要绑定的用户</p>
        <form action="/wLogin.do" method="post">
        ...
        <div class="social-auth-links text-center">
            <p>由于您是第一次扫码，所以需要输入用户名和密码进行绑定</p>
