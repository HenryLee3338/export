...
<script>
    ...
    function return1() {
            location.href="${ctx}/cargo/finance/list.do";
    }
        ...
        <div class="box box-primary">
                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                               <%-- <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/cargo/contract/toAdd.do"'><i class="fa fa-file-o"></i> 新建</button>--%>
                                <button type="button" class="btn btn-default" title="返回发列表" onclick='return1()'><i class="fa  fa-eye-slash"></i> 返回发票表</button>
                        ...
                        <c:forEach items="${page.list}" var="o" varStatus="status">
                            <tr>
                               ...
                               <%-- <td>
                                    ...
                                    <a href="${ctx }/cargo/contract/toUpdate.do?id=${o.financeId}">[编辑]</a>
            ...
            <div class="box-footer">
                <jsp:include page="../../common/page.jsp">
                    <jsp:param value="${ctx}/cargo/finance/list.do" name="pageUrl"/>
                </jsp:include>
            </div>
            <!-- /.box-footer-->
