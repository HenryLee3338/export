        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/cargo/contractProduct/edit.do" method="post"  enctype="multipart/form-data">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <script>
                        ...
                        $(function () {
                            $("#factoryInfo").change(function () {
                                var url="${ctx}/cargo/contractProduct/findHuohao.do";
                                var params={
                                ...
                                $.post(url,params,function (data) {
                                    ...
                                    //let redult=JSON.stringify(data)
                                    $('select[name="huohaoId"]').empty();
                                    for (let huohao of data){
                                        var q=huohao
                                        $(".col-md-4>select").append("<option value=''>" +huohao + "</option>")
                    ...
                    <input type="text" name="productNo" id="huohaoName" hidden value="${contractProduct.factoryName}">
                    <div class="col-md-2 title">货号</div>
                    <div class="col-md-4 data">
                        <select class="form-control" name="huohaoId" id=huohaoInfo"
                                onchange="document.getElementById('huohaoName').value=this.options[this.selectedIndex].text">
                            <option value="">请选择</option>
                        </select>
                    </div>
