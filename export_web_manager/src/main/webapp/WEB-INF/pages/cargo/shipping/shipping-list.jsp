...
<script>
    ...
    function toShip() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/cargo/shipping/toShip.do?id="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="委托" onclick="toShip()"><i class="fa fa-retweet"></i> 委托</button>
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${o.state==2}"><font color="purple">已委托</font></c:if>
                            </td>
                            <td>
                                <%--<a href="${ctx }/cargo/packing/toUpdate.do?id=${o.packingListId}">[编辑]</a>--%>
                                <%--<a href="${ctx }/cargo/shipping/map.do?id=${o.packingListId}">[地图]</a>--%>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
