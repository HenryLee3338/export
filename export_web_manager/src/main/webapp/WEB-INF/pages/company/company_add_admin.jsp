...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/company/setadmin.do" method="post">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-1 title">所属企业</div>
                    <div class="col-md-5 data">
                        <input type="text" class="form-control" placeholder="企业名称" name="companyName" readonly="readonly" value="${company.name}">
                    </div>
                    <div class="col-md-1 title">企业id</div>
                    <div class="col-md-5 data">
                        <input type="text" class="form-control" placeholder="企业id" name="companyId" readonly="readonly" value="${company.id}">
                    </div>
  ...
  --%>
                    ...
                    <div class="col-md-5 data">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" checked="checked" name="degree" value="1" >系统管理员</label></div>
                            <div class="radio"><label><input type="radio"  name="degree" value="2" disabled="disabled">管理下属部门和人员</label></div>
                            <div class="radio"><label><input type="radio"  name="degree" value="3" disabled="disabled">管理本部门</label></div>
                            <div class="radio"><label><input type="radio"  name="degree" value="4" disabled="disabled">普通员工</label></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 data">
                        <input type="text" class="form-control" placeholder="电话" name="telephone" value="${company.phone}">
                    </div>
