...
public class MailUtil {
    ...
    public static void sendMsg(String to ,String subject ,String content) throws Exception{
        ...
        //4.设置消息的发送者
        Address fromAddr = new InternetAddress("henrylee3338@sina.com");
        ...
        //9.设置火箭的发射目标
        transport.connect("smtp.sina.com", "henrylee3338@sina.com", "6d32ea866ab0d89f");
        //10.发送
    ...
    public static void main(String[] args) throws Exception {
        MailUtil.sendMsg("1143759356@qq.com", "今晚八点约陈伟霆", "左手和我一起画个龙，右手画一道彩虹，走起！");
    }
